...
- [x] **T01** Crear `pyproject.toml` — setup del proyecto (uv, dependencias, entrypoint CLI)
  - Commit: `[bootstrap] Add pyproject.toml`

- [x] **T02** Crear `src/sdd_tui/core/models.py` — dataclasses y enums del dominio
  - Commit: `[bootstrap] Add core models`
  - Depende de: T01

- [x] **T03** Crear `tests/conftest.py` — fixture `openspec_dir` con estructura mínima en tmp_path
  - Commit: `[bootstrap] Add test fixtures`
  - Depende de: T02

- [x] **T04** Crear `tests/test_reader.py` — tests del reader (RED)
  - Commit: `[bootstrap] Add reader tests`
  - Depende de: T03

- [x] **T05** Crear `src/sdd_tui/core/reader.py` — OpenspecReader (GREEN)
  - Commit: `[bootstrap] Add OpenspecReader`
  - Depende de: T04

- [x] **T06** Crear `tests/test_pipeline.py` — tests de pipeline + task parser (RED)
  - Commit: `[bootstrap] Add pipeline tests`
  - Depende de: T03

- [x] **T07** Crear `src/sdd_tui/core/git_reader.py` — GitReader vía subprocess
  - Commit: `[bootstrap] Add GitReader`
  - Depende de: T02

- [x] **T08** Crear `src/sdd_tui/core/pipeline.py` — PipelineInferer + TaskParser (GREEN)
  - Commit: `[bootstrap] Add PipelineInferer and TaskParser`
  - Depende de: T06, T07

- [x] **T09** Crear `src/sdd_tui/tui/app.py` — SddTuiApp + main() entrypoint
  - Commit: `[bootstrap] Add TUI app entrypoint`
  - Depende de: T05, T08

- [x] **T10** Crear `src/sdd_tui/tui/epics.py` — EpicsView (DataTable con pipeline)
